...
class JoinableExceptRelation extends Model implements Sheetable
{
    use HasFactory;
    ...
    protected static function newFactory(): JoinableExceptRelationFactory
    {
        return JoinableExceptRelationFactory::new();
    }
